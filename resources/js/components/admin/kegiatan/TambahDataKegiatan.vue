<template>
    <div class="wrapper-nav-side">
        ...
        <form class="form-group" v-on:submit.prevent="tambahdatakegiatan">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="file" class="foto form-control" name="event_foto" v-on:change="onImageChange" id="fotokegiatan"/>
...
export default {
    ...
    methods: {
        ...
        tambahdatakegiatan(){
            ...
            axios.post('/api/admin/events/add',bodyParameters,config).then((res) => 
            {
                this.$swal({
                    title: 'Berhasil!',
