<template>
    <div class="wrapper-nav-side">
        <h3><b>Tambah Data Program Kerja Kategori</b></h3>
        <form class="form-group" v-on:submit.prevent="tambahdataprogramkerjacategory">
...
export default {
    ...
    methods: {
        tambahdataprogramkerjacategory(){
            this.errors = [];
            ...
            axios.post('/api/admin/programkerjacategorys/add',bodyParameters,config).then((res) => 
            {
                this.$swal({
                    title: 'Berhasil!',
                ...
                this.program_kerja_category_description = "";
                this.program_kerja_url = "";
            })
            .catch((res) => {
